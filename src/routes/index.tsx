...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Chiali Clinic — Private medical clinic",
      },
      {
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 lg:grid-cols-2 lg:py-24">
          <div>
            ...
            <p className="mt-4 max-w-md text-lg opacity-90">
              {CLINIC.tagline} Request a slot online and our reception calls
              you back to confirm the exact time.
            </p>
          ...
          <div className="grid items-center gap-8 p-8 md:grid-cols-[1fr_auto] md:p-10">
            <div>
              ...
              <p className="mt-3 max-w-2xl leading-relaxed text-muted-foreground">
                Complete a short health questionnaire and receive a
                machine-learning-assisted diabetes and prediabetes screening
                result.
              </p>

              <p className="mt-4 max-w-2xl text-xs text-muted-foreground">
                This is an educational screening tool and does not diagnose
                diabetes or replace evaluation by a healthcare professional.
              </p>
            </div>
